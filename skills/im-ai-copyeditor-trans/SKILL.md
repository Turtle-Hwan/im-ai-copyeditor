...
**Phase 2** — `python3 $SKILL/scripts/segment.py _workspace/{run_id}/01_input.txt --outdir _workspace/{run_id}` → segments.json + worksheet.md, 문장 수 N 확인.**Phase 3** — 룰북 로드: `$SKILL/references/translationese-rules.md` 와 공통 `$SKILL/references/prime-directives.md`.
