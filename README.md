...
[설치](#설치) · [명령어](#명령어) · [팀·기업용](#팀기업용-품질관리) · [동작 방식](#동작-방식) · [규칙](#규칙) · [기여](#기여)
...
오픈소스는 개인과 팀이 직접 설치해 계속 무료로 쓸 수 있어요.

고객사마다 다른 문체를 유지하거나 비공개 원고의 납품 전 검수 흐름이 필요하면 IILL이 회사 전용 기준을 함께 만들어요.

- **원고 품질 진단 19만 원**: 원고 3건의 교정 전후와 반복 문제 리포트
- **팀 문체 구축 99만 원**: 회사 전용 문체 가이드, 문서 유형 3종, 담당자 교육과 2주 안정화
- **월간 품질관리 55만 원**: 월 20만 자 교정, 반복 오류 리포트와 월 1회 규칙 보정

고객 문서는 동의 없이 공개 사례나 학습 자료로 쓰지 않아요.

**[서비스 범위와 가격 보기 →](https://iill.dev/ko/services/ai-copy-quality/)**
